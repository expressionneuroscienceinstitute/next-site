export const aboutConfig = {
  ...
  mission: {
    title: 'Our Mission',
    text: `Expression Neuroscience Institute (ENI) is a Gen Z-led nonprofit researching how the brain works. We&apos;re particularly interested in mental health conditions like Obsessive Compulsive Disorder (OCD), Attention Deficit Hyperactivity Disorder (ADHD), and Autism Spectrum Disorder (ASD) - partly because our founders and partnerslive with these conditions. Our goal is to make neuroscience research more open, accessible, and useful for everyone.`,
  },
  board: {
    title: 'Board Members',
    members: [
