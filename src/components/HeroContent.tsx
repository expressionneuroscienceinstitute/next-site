...
export default function HeroContent() {
  ...
  return (
    <div className="max-w-3xl">
      <h1
        className={`font-display text-4xl font-extrabold leading-[1.08] tracking-tight text-text-light dark:text-text-dark md:text-5xl lg:text-6xl ${
      ...
      <p
        className={`mt-5 text-lg leading-relaxed text-muted-light dark:text-muted-dark md:text-xl ${
