...
interface SocialLink {
  ...
  type: 'substack' | 'github' | 'linkedin' | 'twitter' | 'youtube' | 'other'
}
...
export const defaultSocialLinks: SocialLink[] = [
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/expression-neuroscience-institute',
    type: 'linkedin',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TikTok',
    href: 'https://www.tiktok.com/@expression.neuroscience',
    type: 'other',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/expressioninstitute/',
    type: 'other',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/expressionneuroscience',
    type: 'other',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
