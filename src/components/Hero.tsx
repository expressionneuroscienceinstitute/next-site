        ...
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:w-full lg:pb-28 xl:pb-32">
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            ...
            <div className="sm:text-center lg:text-left relative">
              ...
              {/* ENI Logo Vector - absolutely positioned */}
              <motion.div
                initial={{ opacity: 0, x: 50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, delay: 0.4 }}
                className="hidden lg:block absolute -top-10 right-10 md:right-5 sm:right-0 text-accent-light dark:text-accent-dark"
              >
                {/* Inline SVG */}
                <svg
                  ...
                  aria-label="Expression Neuroscience Institute Logo"
                >
                  <g fill="currentColor">
